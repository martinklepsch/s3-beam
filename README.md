...
`s3cmd setcors FILE s3://BUCKET`. Please configure s3cmd **first** by following the [offical instructions](https://www.digitalocean.com/community/tutorials/how-to-configure-s3cmd-2-x-to-manage-digitalocean-spaces), **but ensure you set the `Default Region`*** to 'nyc3'. 
